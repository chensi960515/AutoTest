...
from common.unit import apiSend, readRelevance, replaceRelevance
from common.utils import readYaml
...
def init_premise(test_info, case_data, case_path):
    ...
    if test_info['cookies']:
        ...
        logging.debug("请求ciikies处理结果: {}".format(cookies))
